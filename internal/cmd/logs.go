...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View langtut logs",
	Long:  `View the logs generated by Langtut. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logsFile := filepath.Join(cfg.Options.DataDirectory, "logs", "langtut.log")
		_, err = os.Stat(logsFile)
		if os.IsNotExist(err) {
			log.Warn("Looks like you are not in a langtut project. No logs found.")
			return nil
		}
